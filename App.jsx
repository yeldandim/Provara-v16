...
const AMBER = '#ED6F19'
const INK   = '#1A1614'
const DARK  = '#111110'  // dark bg sections — warm near-black, no blue
const WHITE = '#FFFFFF'

/* ═══════════════════════════════════════════
   LOGO COMPONENT
   Single component, two colour modes.
   Sizes used: h=32 (navbar), h=52 (hero), h=20 (footer).
   Nothing else.
═══════════════════════════════════════════ */
function Logo({ h = 32, dark = false }) {
...
/* ═══════════════════════════════════════════
   VA MONOGRAM
   Exact viewBox measured from path coordinates:
   V left edge: 371.37  V right: 426.89
   A left edge: 459.45  A right: 516.53
   Top: 73.68  Bottom: 126.32
   ViewBox = "368 70 152 60" with 3px padding each side.

   Sizes: watermark=260, section accent=32, micro=16.
═══════════════════════════════════════════ */
...
function Navbar() {
  ...
  return (
    <header style={{
      ...
      {/* Logo hidden over hero — hero has the logo. Shows once scrolled. */}
      <a href="#" style={{ textDecoration:'none', opacity: onDark ? 0 : 1, pointerEvents: onDark ? 'none' : 'auto', transition:'opacity .4s' }}>
      ...
      <a href="#contact" className="btn-primary desk"
      ...
      {open && (
        <div style={{
          ...
          background:'rgba(250,250,248,.99)',
          ...
          <a href="#contact" className="btn-primary"
            onClick={() => setOpen(false)}>Let's Talk</a>
        </div>
      )}
    </header>
  )
...
/* ═══════════════════════════════════════════
   HERO — dark bg, logo centred,
   VA monogram as quiet background shape
═══════════════════════════════════════════ */
function Hero() {
  return (
    <section style={{
      ...
      {/* VA watermark — correctly clipped, breathes slowly */}
      ...
      {/* Content — left-aligned, restrained */}
      <div style={{ position:'relative', zIndex:2, maxWidth:'680px' }}>
        ...
        {/* Logo — the wordmark IS the hero heading */}
        ...
        <div className="hl" style={{
          width:'40px', height:'2px', background:AMBER, marginBottom:'24px',
        }} />

        {/* Single clear tagline — no font gymnastics */}
        <p className="h3" style={{
          fontFamily:'var(--serif)', 
          fontSize:'clamp(18px,2.2vw,26px)', fontWeight:400,
          lineHeight:1.55, color:'rgba(255,255,255,.65)',
          maxWidth:'540px', marginBottom:'36px',
        }}>
          Strategic construction leadership for projects
        ...
        {/* VA taglines — small, consistent */}
        <div className="h5" style={{
          display:'flex', gap:'32px', alignItems:'center',
          paddingTop:'28px', borderTop:'1px solid rgba(255,255,255,.1)',
          flexWrap:'wrap',
        }}>
...
/* ═══════════════════════════════════════════
   SERVICES — all 8 visible, no clicks needed
   McKinsey-style: clean ruled list with
   brief but complete descriptions
═══════════════════════════════════════════ */
const SVCS = [
  ["Owner's Representation",
   "Independent owner-side advocacy through design, procurement, and construction. Your interests protected at every decision point — not your contractor's."],
  ["Construction Management",
   "Full program oversight from groundbreaking through closeout: contractor coordination, schedule control, quality assurance, and cost management."],
  ["CPM / P6 Scheduling",
   "Baseline schedules, updates, and forensic analysis in Primavera P6 and MS Project. Legally defensible, field-executable, and written in plain English."],
  ["Capital Project Advisory",
   "Strategic guidance on delivery methods, budget structuring, procurement strategy, and risk allocation for major capital investments."],
  ["Development Consulting",
   "Pre-development advisory covering feasibility, entitlement strategy, design management, and delivery planning for ground-up development."],
  ["Due Diligence & Risk Oversight",
   "Independent technical review, project audits, and risk assessments for investors, lenders, and acquirers evaluating construction exposure."],
  ["Program Management",
   "Multi-site, multi-phase oversight with standardized reporting, governance, and controls — from a single accountable point of contact."],
  ["Facilities & Asset Strategy",
   "Long-range planning, operational readiness, and asset management frameworks that protect the value of built environments over time."],
]
      ...
      <div style={{ maxWidth:MW, margin:'0 auto' }}>
        ...
        <div ref={rH} className="rv" style={{
          ...
          <p style={{
            ...
            fontSize:'15px', lineHeight:1.75, color:'var(--mid)',
            alignSelf:'end',
          }}>
            Every engagement draws on multiple disciplines. Whether you need a single
            specialist service or end-to-end construction leadership, Provara brings
            the same rigour to every scope.
          </p>
        </div>

        {/* Service list — 2 columns, all visible */}
        <div style={{
          display:'grid',
          ...
          {SVCS.map(([title, body], i) => {
            ...
            const isRight = i % 2 === 1
            return (
              <div key={title} ref={r} className={`rv d${(i%4)+1}`}
                style={{
                  padding:'28px 0',
                  borderBottom:'1px solid var(--rule)',
                ...
                <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'10px' }}>
                  ...
                  <h3 style={{
                    ...
                    fontSize:'15px', color:'var(--ink)', lineHeight:1.2,
                  }}>{title}</h3>
                </div>
                <p style={{
                  fontFamily:'var(--sans)', fontWeight:400,
                  fontSize:'14px', lineHeight:1.75, color:'var(--mid)',
...
/* ═══════════════════════════════════════════
   P6 SCHEDULING — all 6 items always visible.
   Dark section, emphasis.
═══════════════════════════════════════════ */
const SCHED = [
  ['CPM Schedule Development',
   'Baseline schedules built to Critical Path Method standards — activity-sequenced, resource-loaded, and structured to withstand owner, lender, and contractor review.'],
  ['Primavera P6 Expert Delivery',
   'Expert scheduling in Primavera P6 and MS Project. Schedules your field team can execute and your PM can defend in any review meeting.'],
  ['Schedule Updates & Maintenance',
   'Periodic updates with variance analysis, look-ahead windows, and clear narrative reporting written in plain English — not just Gantt charts.'],
  ['Delay Analysis & Claims Support',
   'Forensic schedule analysis, time impact assessments, and contemporaneous documentation that protects your position in disputes and claims.'],
  ['Recovery Scheduling',
   'When a project falls behind: identify critical path bottlenecks, model recovery scenarios, and build executable acceleration plans.'],
  ["Owner's Schedule Review",
   "Independent audit of contractor-submitted schedules — finding logic errors and unrealistic durations before they compound into cost overruns."],
]

function Scheduling() {
  const rH = useReveal()
  return (
    <section id="scheduling" style={{
      background: DARK,
      padding: `${SEC} ${PAD}`,
    }}>
      <div style={{ maxWidth:MW, margin:'0 auto' }}>
        ...
        <div ref={rH} className="rv" style={{
          ...
          <div style={{ alignSelf:'end' }}>
            <p style={{
              ...
              Most schedules satisfy a contract requirement, not manage a project.
              We build CPM and P6 schedules that are field-executable, legally
              defensible, and genuinely useful — from bid phase through closeout.
            </p>
        ...
        {/* All 6 items — 2-column grid, all visible */}
        <div style={{
          ...
          {SCHED.map(([ title, body], i) => {
            ...
            const isRight = i % 2 === 1
            return (
              <div key={title} ref={r} className={`rv d${(i%3)+1}`}
                style={{
                  padding:'28px 0',
                ...
                <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'10px' }}>
                  ...
                  <h3 style={{
                    fontFamily:'var(--sans)', fontWeight:500,
                    fontSize:'15px', color:WHITE, lineHeight:1.2,
                  }}>{title}</h3>
                </div>
                <p style={{
                  fontFamily:'var(--sans)', fontWeight:400,
        ...
        <div style={{
          ...
          <p style={{
            ...
            color:'rgba(255,255,255,.7)', margin:0, maxWidth:'560px',
          }}>
            Every schedule includes a written narrative, logic summary, and
            critical path explanation in plain English — not just a Gantt chart.
          </p>
          <a href="#contact" className="btn-primary" style={{ flexShrink:0 }}>
            Get a Schedule Quote →
          </a>
        </div>
      </div>
    </section>
      ...
      <div style={{ maxWidth:MW, margin:'0 auto' }}>
        <div ref={rH} className="rv" style={{
          ...
          <p style={{
            ...
            Owners, developers, lenders, general contractors, and institutional
            investors across complex project types and geographies.
          </p>
        </div>
          ...
          {SECTORS.map(([name, sub], i) => {
            ...
            return (
              <div key={name} ref={r} className={`rv d${(i%4)+1}`}
                style={{
                  background:'var(--off)', padding:'24px 22px',
                  borderTop:'2px solid transparent',
                  transition:'border-color .25s, background .25s',
                }}
                onMouseEnter={e => {
                  e.currentTarget.style.borderTopColor = AMBER
  ...
  return (
    <section id="leadership" style={{ background:WHITE, overflow:'hidden' }}>
      <div style={{
        ...
        {/* Photo */}
        <div ref={r1} className="rv" style={{ position:'relative', minHeight:'200px' }}>
        ...
        {/* Bio */}
        <div ref={r2} className="rv d2" style={{
          ...
          <h2 style={{
            fontFamily:'var(--serif)', fontWeight:400,
            fontSize:'clamp(24px,2.8vw,36px)', lineHeight:1.15,
            color:'var(--ink)', letterSpacing:'-.02em',
            marginBottom:'24px',
          }}>
            Mithul Yeldandi
          ...
          <p style={{
            fontFamily:'var(--sans)', fontSize:'15px', lineHeight:1.8,
            color:'var(--mid)', marginBottom:'16px',
          }}>
            Mithul Yeldandi founded Provara with a clear conviction: owners deserve the
            same caliber of strategic construction leadership that major institutions
            take for granted. His career sits at the intersection of owner representation,
            capital project delivery, and construction management.
          </p>
          <p style={{
            fontFamily:'var(--sans)', fontSize:'15px', lineHeight:1.8,
            color:'var(--mid)', marginBottom:'16px',
          }}>
            He has led construction and facilities operations at the director level,
            managed projects for a top-ranked ENR general contractor, and holds a
            Master's in Construction Management from UT Arlington.
          </p>
          <p style={{
            fontFamily:'var(--sans)', fontSize:'15px', lineHeight:1.8,
            color:'var(--mid)', marginBottom:'32px',
          }}>
            Mithul serves as Program Chair for the CMAA South Central Texas Chapter
            and as a Program Evaluator for ABET.
          </p>

          {/* Credentials — VA micro icon as bullet */}
          <div style={{
            ...
            {[
              ...
              <div key={code} style={{
                ...
                <span style={{
                  ...
                  color:AMBER, minWidth:'38px',
                }}>{code}</span>
                <span style={{
                  fontFamily:'var(--sans)', fontWeight:400,
                  fontSize:'13px', color:'var(--mid)',
                }}>{label}</span>
              </div>
            ))}
          </div>
          ...
          <blockquote style={{
            borderLeft:`2px solid ${AMBER}`,
            paddingLeft:'18px', marginTop:'auto',
          }}>
            <p style={{
              fontFamily:'var(--serif)', fontWeight:400,
              ...
              "Projects fail in the gaps between responsibility and accountability.
              We close those gaps."
            </p>
            <cite style={{
              fontFamily:'var(--sans)', fontSize:'11px', fontWeight:400,
              letterSpacing:'.08em', textTransform:'uppercase',
              color:'var(--ghost)', fontStyle:'normal',
            }}>
...
/* ═══════════════════════════════════════════
   APPROACH — 4 steps, all visible
═══════════════════════════════════════════ */
const STEPS = [
  ['01', 'Align Before You Build',
   'Every engagement begins with a diagnostic of scope, risk, team capability, and owner objectives. Misalignment at the start compounds through every phase of construction.'],
  ['02', 'Build Defensible Systems',
   'We establish the reporting structures, documentation standards, and decision protocols that give owners real-time visibility and legal defensibility throughout execution.'],
  ['03', 'Close the Gaps',
   'Most projects fail in the white space between contracts. We identify those gaps early and assign clear ownership before they become disputes or claims.'],
  ['04', 'Deliver With Accountability',
   'We measure success against your objectives — not industry averages. On-budget, on-schedule, and operationally ready is the standard, not the exception.'],
]
...
function Approach() {
  ...
  return (
    <section id="approach" style={{
      background:'var(--off)', padding:`${SEC} ${PAD}`,
      ...
      <div style={{ maxWidth:MW, margin:'0 auto' }}>
        <div ref={rH} className="rv" style={{
          ...
          <p style={{
            ...
            Provara's process is built around one principle: the owner's interests
            come first, and every system we build serves that outcome.
          </p>
        </div>
        ...
        <div style={{
          ...
          {STEPS.map(([n, title, body], i) => {
            ...
            const isRight = i % 2 === 1
            return (
              <div key={n} ref={r} className={`rv d${i+1}`}
                style={{
                  padding:'32px 0',
                  borderBottom:'1px solid var(--rule)',
                  borderLeft: isRight ? '1px solid var(--rule)' : 'none',
...
function Contact() {
  ...
  const fi = {
    ...
    border:'none', borderBottom:'1px solid rgba(255,255,255,.18)',
        ...
        <div ref={r1} className="rv" style={{
          ...
          <div>
            ...
            <h2 style={{
              ...
              <em style={{ color:AMBER }}>project.</em>
            </h2>
            <p style={{
              fontFamily:'var(--sans)', fontWeight:400,
              fontSize:'15px', lineHeight:1.75,
              ...
              with an honest assessment of where we can add value.
            </p>
            <div>
              <div style={{
                fontFamily:'var(--sans)', fontSize:'11px', fontWeight:500,
          ...
          <div style={{
            ...
            <Logo h={20} dark={true} />
            <div style={{
              display:'flex', gap:'24px', marginTop:'14px', flexWrap:'wrap',
            }}>
              {['Vision Aligned', 'Value Assured'].map(label => (
        ...
        <div ref={r2} className="rv d2" style={{
          ...
          {sent ? (
            <div style={{
              ...
              <h3 style={{
                fontFamily:'var(--serif)', fontWeight:400,
                fontSize:'28px', color:WHITE, letterSpacing:'-.02em',
              }}>
                Email draft ready.
              </h3>
              <p style={{
                fontFamily:'var(--sans)', fontSize:'14px',
                color:'rgba(255,255,255,.4)', maxWidth:'280px', lineHeight:1.7,
              }}>
                Your email client opened. Send when ready — we respond within
                one business day.
              </p>
            ...
            <form onSubmit={submit} style={{ display:'flex', flexDirection:'column' }}>
              <h3 style={{
                fontFamily:'var(--serif)', fontWeight:400,
                fontSize:'clamp(22px,2.5vw,30px)', color:WHITE,
                letterSpacing:'-.02em', marginBottom:'36px', lineHeight:1.1,
              }}>
              ...
              <div style={{ marginBottom:'24px' }}>
                ...
                <select value={form.service}
                  ...
                  style={{
                    ...fi, appearance:'none', cursor:'pointer',
                    color: form.service ? WHITE : 'rgba(255,255,255,.35)',
                  }}
                  onFocus={e => e.target.style.borderBottomColor = AMBER}
                  onBlur={e => e.target.style.borderBottomColor = 'rgba(255,255,255,.18)'}>
                  <option value="" style={{background:'#111110'}}>Select a service...</option>
                  {['CPM / P6 Scheduling',"Owner's Representation",'Construction Management',
                    'Capital Project Advisory','Development Consulting',
                    'Due Diligence & Risk Oversight','Program Management',
                    'Delay Analysis & Claims','Other / Multiple'].map(s => (
              ...
              <div style={{ marginBottom:'36px' }}>
                ...
                <textarea required rows={5}
                  placeholder="Project type, location, timeline, and where you need support..."
                  value={form.message}
...
function Footer() {
  return (
    <footer style={{
      background:DARK, borderTop:'1px solid rgba(255,255,255,.07)',
      padding:`clamp(40px,5vw,56px) ${PAD} 28px`,
    }}>
      <div style={{ maxWidth:MW, margin:'0 auto' }}>
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              color:'rgba(255,255,255,.3)', marginTop:'14px',
              lineHeight:1.75, maxWidth:'220px',
            }}>
              Construction management, P6 scheduling, and owner's
              representation — San Antonio, TX.
            </p>
            <div style={{
          ...
          {[
            ...
            <div key={col.h}>
              <div style={{
                fontFamily:'var(--sans)', fontSize:'11px', fontWeight:500,
                letterSpacing:'.1em', textTransform:'uppercase',
                color:AMBER, marginBottom:'14px',
              }}>{col.h}</div>
              {col.items.map(([lbl, href]) => (
                <a key={lbl} href={href}
                  style={{
                    display:'block', fontFamily:'var(--sans)', fontSize:'13px',
                    color:'rgba(255,255,255,.32)', textDecoration:'none',
                    marginBottom:'8px', transition:'color .2s',
                  }}
